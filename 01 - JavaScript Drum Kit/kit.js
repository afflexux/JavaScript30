...
keys.forEach(key => key.addEventListener("transitionend", removeTransition)); // listening for transitionend (css event that is fired) then runs the function removeTransition
